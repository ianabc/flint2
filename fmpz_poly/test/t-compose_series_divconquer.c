...
main(void)
{
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_compose_series_divconquer(s, g, h, n);
        fmpz_poly_compose_divconquer(f, g, h);
        fmpz_poly_truncate(f, n);
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_compose_series_divconquer(f, g, h, n);
        fmpz_poly_compose_series_divconquer(g, g, h, n);
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_poly_compose_series_divconquer(f, g, h, n);
        fmpz_poly_compose_series_divconquer(h, g, h, n);
